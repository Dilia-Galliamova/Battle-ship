...
class PlayerHuman:
    ...
    def init_desk(self, desk):
        count = 1
        k = 1
        print("Please follow the instruction to enter ship indexes one by one.")
        print("Index is a 2-digit number (for example 11, 12 etc.)")
        print("Take a note that 3-cell ship can be curved (Г-shape) in 4 ways.")
        desk.print_field(1)
        while count != 8:
